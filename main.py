...
app = Flask(__name__)
app.config['SECRET_KEY'] = '8BYkEfBA6O6donzWlSssss'
Bootstrap5(app)
...
def add_cafe():
    ...
    if form.validate_on_submit():
        ...
        with open('cafe-data.csv', 'a', newline='') as csvfile:
            ...
            writer.writerow([cafe,location,open_time,close,coffee,wifi,power])
...
def cafes():
    with open('cafe-data.csv', newline='', encoding='utf-8') as csv_file:
        ...
        list_of_rows.pop(0)
    return render_template('cafes.html', cafes=list_of_rows,number=count)
